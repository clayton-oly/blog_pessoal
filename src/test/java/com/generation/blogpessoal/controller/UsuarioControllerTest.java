...
public class UsuarioControllerTest {
	...
	public void deveListarApenasUmUsuario() {
		Optional<Usuario> usuarioBusca = usuarioService.cadastrarUsuario(new Usuario(0L, "Leo Santana",
				"leo.santana@email.com", "ds923942232", "https://i.imgur.com/iuwi2324.jpg"));
	...
	public void deveAutenticarUsuario() {
		usuarioService.cadastrarUsuario(
				new Usuario(0L, "Otavio Mesquita", "aaa@email.com", "923744424", "https://i.imgur.com/sdfwed.jpg"));
		HttpEntity<UsuarioLogin> corpoRequisicao = new HttpEntity<UsuarioLogin>(
				new UsuarioLogin(0L, "", "aaa@email.com", "13465278", "", ""));
