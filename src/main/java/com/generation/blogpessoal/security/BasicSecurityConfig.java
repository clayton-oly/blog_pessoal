...
public class BasicSecurityConfig extends WebSecurityConfigurerAdapter{
	...
	/**
	 * Sobrescreve (@Override) o primeiro método Configure, que tem a função de
	 ...
	 * Lembrete:
	 * 
	 * 1) public: permite acesso a qualquer código externo a classe. 2) protected:
	 * permite acesso às classes filhas, mas proíbe a qualquer outro acesso externo.
	 * 3) private: proíbe qualquer acesso externo à própria classe, inclusive das
	 * classes filhas.
	 */
	 ...
	 * 
	 * O método abaixo é responsável por criptografar a senha do usuário utilizando
	 * o método hash Bcrypt.
	 */
